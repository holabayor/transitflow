    ...
    <div className="top-0 md:top-[-60px] flexCenter overflow-hidden relative">
      ...
      <div className="pageWidth z-10 py-8 sm:py-24 md:py-48">
        <div className="max-w-full sm:max-w-[400px] md:max-w-[570px]">
          ...
          <span className="px-4 py-2 bg-[#041c37] bg-opacity-50 text-white text-[12px]">
            Logistics & Supply Chain Solution
          </span>
          <h1 className="font-bold font-rubik text-white text-[26px] sm:text-[32px] md:text-[40px] xl:text-[60px] leading-tight sm:leading-tight pt-2">
            Your Gateway&nbsp;
          ...
          <p className="text-white text-[12px] sm:text-[16px] py-4 md:py-6">
